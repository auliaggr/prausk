        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php">Pengguna</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="pengaduan.php">Pengaduan</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="btn btn-utama mx-2" href="../../register.php">Register</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
